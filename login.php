    ...
    <div class="container">
        ...
        <div class="left-column">
            <div class="form-container">
                <h2>Welcome To HELP (Health Environment And Life Pure) Website !</h2>
                  ...
                  if(isset($_POST["Submit"]))
                  {
                    Include 'config.php';
                      ...
                      if ($uname != "" && $password != ""){
                          ...
                          $sql_query = "SELECT count(*) as cntUser from `user` WHERE `uName` ='".$uname."' and `uPassword` ='".$password."'";
              ...
              ?>
                <a href="cNewAccount.php">Create New account? Click here...</a>
            </div>
        </div>
